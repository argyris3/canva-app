export const Element = ({ id, info, exId }) => {
  return (
    <>
      {exId ? (
        <>
      ...
      <div
        onMouseDown={() => info.moveElement(id, info)}
        className="hidden absolute group-hover:block top-[50%] -right-[3px] translate-[-50%,0%] w-[10px]  h-[10px] cursor-nesw-resize bg-blue-600 z-[99999] "
      ></div>
      <div
        onMouseDown={() => info.moveElement(id, info)}
