    ...
    <div className="h-[60px] bg-gradient-to-r from-[#212122] via-[#27282b] to-[#2a2b2c]  w-full">
      <div className="flex justify-between px-10 items-center text-gray-400 h-full">
        ...
        <div className="flex justify-center items-center gap-2 text-gray-200">
          <button disabled={loader} onClick={saveImage} className="px-2 py-[6px] outline-none bg-[#7482f6] rounded-md ">
            {loader ? 'Loading..' : 'Save'}
          </button>
          <button onClick={downloadImage} className="px-2 py-[6px] outline-none bg-[#a855f7] rounded-md ">
            Download
          </button>
        </div>
      </div>
