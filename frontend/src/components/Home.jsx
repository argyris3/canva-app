...
const Home = () => {
  ...
  return (
    <div className="pt-3 pl-3">
      <div className="w-full flex justify-center items-center h-[250px] bg-gradient-to-r from-[#4c76cf] to-[#552cf8] relative rounded-md overflow-hidden">
        <button
          onClick={() => setShow(!show)}
          className="px-4 py-2 text-[15px] overflow-hidden text-center bg-[#27a266ad]  text-white rounded-[3px] font-medium hover:bg-[#1e830f] absolute top-3 right-3"
        >
          Custom Size
        </button>
        ...
        <form
          ...
          className={`absolute top-16 right-0 gap-0 bg-[#252627] w-[250px] p-4 text-white ${
        ...
        >
          ...
          <button className="px-4 py-2 text-[15px] overflow-hidden text-center bg-[#27a266ad]  text-white rounded-[3px] font-medium hover:bg-[#1e830f] w-full">
            New Design Here..
          </button>
        </form>
        <div>
