    ...
    <div className="bg-[#18191b] min-h-screen w-full ">
      ...
      >
        <div className="w-[350px] m-auto px-6 py-4 rounded-md relative bg-[#323335]">
          ...
          <h2 className="text-white pb-4 text-center text-xl">Login and Register in seconds...</h2>
          {type === 'signin' && (
            <form>
      ...
      <div className="w-full h-full justify-center items-center p-4">
        <div className="py-[170px] flex justify-center items-center flex-col gap-6">
          <h2 className="text-5xl text-[#c7c5c5]  font-bold">Release Your Imagination..</h2>
