    ...
    <div className="bg-[#18191b] min-h-screen w-full">
          ...
          {type === "signin" && (
            <form onSubmit={user_login}>
              ...
              <div>
                <button
                  disabled={loader}
                  className="px-3 py-2 rounded-md bg-purple-500 w-full outline-none hover:bg-purple-700 text-white"
                >
              ...
              <div className="pb-4">
                <button className="px-3 flex justify-center items-center gap-2 py-2 rounded-md bg-red-500 w-full outline-none hover:bg-red-700 text-white">
                  <span>
                    <BiLogoGmail />
                  </span>
      ...
      <div className="w-full h-full justify-center items-center p-4">
        <div className="py-[170px] flex justify-center items-center flex-col gap-6">
          ...
          <button className="py-2 w-200px] text-center bg-purple-500 text-white font-medium transition-all hover:bg-purple-500 rounded-[5px] px-4">
            Explore
          </button>
        </div>
      </div>
